...
#line 97 ".\\myparser.y"
		...
		VarNode *cur = (VarNode*)yyattribute(2 - 3).varnode;
		...
		curr->addChildNode(yyattribute(1 - 3).typenode);
		yyattribute(1 - 3).typenode->addPeerNode(yyattribute(2 - 3).varnode);
		(*(YYSTYPE YYFAR*)yyvalptr).node = curr;
...
#line 131 ".\\myparser.y"
		...
		VarNode *cur = new VarNode(string(yyattribute(1 - 4).symp->name));
...
void YYPARSERNAME::yytables()
{
	...
	static const yystateaction_t YYNEARFAR YYBASED_CODE stateaction[] = {
		...
		{ 118, 1, YYAT_ERROR, 0 },
		{ -105, 1, YYAT_ERROR, 0 },
		{ 133, 1, YYAT_DEFAULT, 55 },
		{ -129, 1, YYAT_ERROR, 0 },
		{ 0, 0, YYAT_DEFAULT, 103 },
		{ 0, 0, YYAT_REDUCE, 4 },
		{ -108, 1, YYAT_DEFAULT, 145 },
		{ 0, 0, YYAT_REDUCE, 5 },
		{ 0, 0, YYAT_REDUCE, 12 },
		{ 129, 1, YYAT_ERROR, 0 },
		...
		{ 0, 0, YYAT_REDUCE, 84 },
		{ 0, 0, YYAT_DEFAULT, 103 },
		{ 66, 1, YYAT_DEFAULT, 150 },
		{ 0, 0, YYAT_REDUCE, 31 },
		{ 0, 0, YYAT_REDUCE, 11 },
		{ 2, 1, YYAT_DEFAULT, 62 },
		{ 0, 0, YYAT_REDUCE, 15 },
		{ 0, 0, YYAT_REDUCE, 10 },
		{ 83, 1, YYAT_DEFAULT, 167 },
		{ 58, 1, YYAT_REDUCE, 79 },
		{ 0, 0, YYAT_DEFAULT, 129 },
		{ 0, 0, YYAT_DEFAULT, 129 },
		{ -15, 1, YYAT_DEFAULT, 24 },
		{ 0, 0, YYAT_DEFAULT, 129 },
		{ 0, 0, YYAT_DEFAULT, 129 },
		{ 77, 1, YYAT_DEFAULT, 161 },
		{ 0, 0, YYAT_REDUCE, 25 },
		{ 0, 0, YYAT_REDUCE, 27 },
		{ 0, 0, YYAT_REDUCE, 38 },
		{ 0, 0, YYAT_REDUCE, 39 },
		...
		{ 0, 0, YYAT_REDUCE, 14 },
		{ 0, 0, YYAT_REDUCE, 80 },
		{ 70, 1, YYAT_DEFAULT, 167 },
		{ 69, 1, YYAT_DEFAULT, 167 },
		{ 50, 1, YYAT_DEFAULT, 140 },
		{ 0, 0, YYAT_DEFAULT, 129 },
		{ 48, 1, YYAT_DEFAULT, 150 },
		{ 64, 1, YYAT_DEFAULT, 167 },
		{ 61, 1, YYAT_DEFAULT, 167 },
		{ 0, 0, YYAT_REDUCE, 81 },
		{ -30, 1, YYAT_REDUCE, 85 },
		{ 59, 1, YYAT_ERROR, 0 },
		{ 0, 0, YYAT_REDUCE, 58 },
		...
		{ -13, 1, YYAT_REDUCE, 69 },
		{ -15, 1, YYAT_REDUCE, 67 },
		{ 124, 1, YYAT_REDUCE, 65 },
		{ 92, 1, YYAT_REDUCE, 66 },
		{ -22, 1, YYAT_REDUCE, 68 },
		{ 152, 1, YYAT_REDUCE, 70 },
		{ -2, 1, YYAT_REDUCE, 63 },
		{ 145, 1, YYAT_REDUCE, 71 },
		{ -45, 1, YYAT_REDUCE, 78 },
		{ 26, 1, YYAT_REDUCE, 77 },
		{ 33, 1, YYAT_REDUCE, 76 },
		{ 61, 1, YYAT_REDUCE, 72 },
		{ 54, 1, YYAT_REDUCE, 75 },
		{ 122, 1, YYAT_REDUCE, 73 },
		...
		{ 24, 1, YYAT_REDUCE, 64 },
		{ 41, 1, YYAT_DEFAULT, 167 },
		{ 18, 1, YYAT_DEFAULT, 140 },
		{ 0, 0, YYAT_REDUCE, 34 },
		{ 0, 0, YYAT_REDUCE, 35 },
		{ 33, 1, YYAT_DEFAULT, 161 },
		{ 0, 0, YYAT_REDUCE, 82 },
		{ 0, 0, YYAT_REDUCE, 60 },
		{ -9, 1, YYAT_REDUCE, 62 },
		{ -210, 1, YYAT_REDUCE, 52 },
		{ -211, 1, YYAT_REDUCE, 53 },
		{ 0, 0, YYAT_REDUCE, 36 },
		{ 0, 0, YYAT_REDUCE, 37 },
		{ 0, 0, YYAT_REDUCE, 51 },
		{ 24, 1, YYAT_DEFAULT, 167 },
		{ 15, 1, YYAT_DEFAULT, 161 },
		{ -4, 1, YYAT_DEFAULT, 129 },
		{ 9, 1, YYAT_DEFAULT, 161 },
		{ -22, 1, YYAT_DEFAULT, 150 },
		{ 0, 0, YYAT_REDUCE, 86 },
		{ 0, 0, YYAT_DEFAULT, 145 },
		{ -149, 1, YYAT_DEFAULT, 129 },
		{ 0, 0, YYAT_REDUCE, 50 },
		{ 0, 0, YYAT_REDUCE, 49 },
		{ -12, 1, YYAT_DEFAULT, 167 },
		{ -14, 1, YYAT_DEFAULT, 161 },
		{ -39, 1, YYAT_DEFAULT, 125 },
		{ 0, 0, YYAT_REDUCE, 47 },
		{ -22, 1, YYAT_DEFAULT, 167 },
		{ -23, 1, YYAT_DEFAULT, 161 },
		{ 0, 0, YYAT_REDUCE, 54 },
		{ 0, 0, YYAT_REDUCE, 55 },
		{ 0, 0, YYAT_REDUCE, 56 },
		{ 0, 0, YYAT_REDUCE, 57 },
		{ 0, 0, YYAT_REDUCE, 46 },
		{ 0, 0, YYAT_REDUCE, 48 },
		{ -32, 1, YYAT_DEFAULT, 167 },
		{ -19, 1, YYAT_ERROR, 0 },
		{ 0, 0, YYAT_REDUCE, 44 },
		{ 0, 0, YYAT_REDUCE, 42 },
		{ -39, 1, YYAT_DEFAULT, 167 },
		{ 0, 0, YYAT_REDUCE, 45 },
		{ 0, 0, YYAT_REDUCE, 43 },
		{ -37, 1, YYAT_ERROR, 0 },
		{ 0, 0, YYAT_REDUCE, 40 },
